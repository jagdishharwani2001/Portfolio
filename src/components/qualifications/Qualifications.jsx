        ...
        <div className="qualification__sections">
          ...
          >
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">RBSE(Perc. : 80%)</h3>
                <span className="qualification__subtitle">
                  Rajasthan Noble School,Falna
                </span>
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title"> RBSE (Perc : 84%)</h3>
                <span className="qualification__subtitle">
                  Rajasthan Noble  School Falna
                </span>
                <div className="qualification__calendar">
          ...
          >
            <div className="qualification__data">
              ...
              <div>
                ...
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt"></i> 04/2024 - 06/2024
                </div>
              </div>
            </div>
